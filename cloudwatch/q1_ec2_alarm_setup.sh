...
AMI_ID="${AMI_ID:-ami-0c94855ba95c71c99}"
INSTANCE_TYPE="${INSTANCE_TYPE:-t2.micro}"
KEY_NAME="${KEY_NAME:-my-key-pair}"
SECURITY_GROUP_ID="${SECURITY_GROUP_ID:-sg-0123456789abcdef0}"
...
echo "Done! Alarm '$ALARM_NAME' created and attached to SNS topic '$SNS_TOPIC_ARN'."
